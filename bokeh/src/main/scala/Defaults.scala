...
trait EnumDefaults {
    ...
    implicit object SpatialUnitsDefault extends DefaultValue[SpatialUnits](SpatialUnits.Screen)
    implicit object AngularUnitsDefault extends DefaultValue[AngularUnits](AngularUnits.Deg)
